...
class ModelBusyError(LLMClientError):
    """Raised when all LM Studio model slots are occupied."""
    pass


# Maximum number of models LM Studio can keep loaded simultaneously.
_LM_STUDIO_MAX_LOADED = int(os.environ.get("LM_STUDIO_MAX_LOADED", "2"))
