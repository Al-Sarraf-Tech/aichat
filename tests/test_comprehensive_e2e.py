...
class TestToolInventory:
    ...
    def test_tools_list(self):
        ...
        assert len(names) == 16, f"Expected 16 mega-tools, got {len(names)}"
...
class TestBrowser:
    ...
    def test_browser_navigate(self):
        ...
        if "name or service not known" in text.lower() or "errno" in text.lower():
            pytest.skip("browser container not reachable from this network")
